...
from mamba_ssm import Mamba # JH download 11/14/2024, https://github.com/state-spaces/mamba (Complie with Numpy 1.x only, also required)
...
class BrainMamba1(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, d_state, d_conv, expand, scale_factor=1, logger=None):
        super(BrainMamba1, self).__init__()
