...
from EEGPT_models.utils import WarmupCosineSchedule, CosineWDSchedule, grad_logger
#from EEGPT_models.modeling_pretraining import EEGTransformer, EEGTransformerPredictor, EEGTransformerReconstructor, apply_mask
from EEGPT_models.modeling_pretraining import EEGTransformer, apply_mask
from EEGPT_models.configs import *
...
class LitEEGPT(pl.LightningModule):
    ...
    def forward(self, x):
        ...
        Returns: a Tensor for demonstration (B, some_dim, some_other_dim)
        """
        z = self.encoder(x, self.chans_id.to(x.device))  # or self.chans_id if in same device
        return z
...
if __name__ == "__main__":
    print("Running as main => do dataset/training ...")
    # ...
